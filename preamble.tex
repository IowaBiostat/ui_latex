...
\hypersetup{colorlinks=true, citecolor=black, linkcolor=uiblue,urlcolor=uiblue}
...
% special rotated character symbols
\providecommand{\tone}{\widetilde{1}}
\providecommand{\bone}{{\mathbf{1}}}
\providecommand{\tbone}{\widetilde{\mathbf{1}}}
\providecommand{\tvep}{\widetilde{\varepsilon}}
\providecommand{\tveph}{\hat{\widetilde{\varepsilon}}}
\providecommand{\tbvep}{\widetilde{\boldsymbol{\varepsilon}}}
\providecommand{\ty}{\widetilde{y}}
\providecommand{\tx}{\widetilde{x}}
...
%% Mathematical
\providecommand{\0}{\mathbf{1}}
\providecommand{\1}{\mathbf{0}}
...
% note: these lines are for use in Overleaf or other .tex editor -- these commands need to be modified when using R Markdown version of template
